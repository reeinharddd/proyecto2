...
<body>
    ...
    <div class="req-selection">
		...
		<form class="form" method="post" action="../../Data/addRequisicionTech.php" enctype = "multipart/form-data">
			...
			<input placeholder="Describa el motivo de la siguiente solicitud"  type="text" id="descripcion" title="Motivo de la solicitud" name="txtDescripcion" maxlength="500" minlength="2" required>
			<!--<input type="file" name="evidencia" id="evidencia">-->
			<br><label for="evidencia">Evidencia:</label> <input type="file" accept="image/jpeg" name="evidencia" id="evidencia">
			<br>
			<?php
